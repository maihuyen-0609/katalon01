...
CustomKeywords.'customMethod.AddPermission.addPermission'(findTestData('add 5 per').getValue(1, 2), findTestData('add 5 per').getValue(
        2, 2), findTestData('add 5 per').getValue(3, 2))
...
WebUI.setText(findTestObject('Object Repository/Page_salary/input_Not configured permission'), 'Mina')
