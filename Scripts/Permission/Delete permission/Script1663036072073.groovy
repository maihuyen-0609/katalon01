...
WebUI.click(findTestObject('Page_salary/button_Login'), FailureHandling.STOP_ON_FAILURE)

WebUI.maximizeWindow()

WebUI.click(findTestObject('Page_salary/Menu_Permission'))

WebUI.click(findTestObject('Page_salary/button_Filter Permission name'))

WebUI.setText(findTestObject('Object Repository/Page_salary/input_search'), 'Mina2')
...
WebUI.click(findTestObject('Object Repository/Page_salary/button_Delete'))

WebUI.click(findTestObject('Object Repository/Page_salary/selectoption_Yes'))

WebUI.click(findTestObject('Object Repository/Page_salary/noti_SuccessDeleted successfully'))
